...
(function (window, undefined) {
    ...
    jQuery.ajax = function (url, options) {
        ...
        ///     A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option withlet ajax_ =  $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.
        /// </param>
    ...
    jQuery.ajaxPrefilter = function (dataTypeExpression, func) {
        /// <summary>
        ///     Handle custom Ajax options or modify existing options before each request is sent and before they are processed bylet ajax_ =  $.ajax().
        /// </summary>
