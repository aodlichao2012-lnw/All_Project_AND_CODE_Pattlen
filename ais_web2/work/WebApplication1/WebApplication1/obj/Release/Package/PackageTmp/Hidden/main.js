...
$("#occ_tel").text(getCookie("type_db"))
...
//    alert("66666")
//    $.ajax({
//        url: 'https://localhost:44315/UserName/GetUserName',
//        type: 'GET',
//        success: function (e) {
//            $("#label_username").val(e)
//        }
//    })
//}
//$("#label_username").on('load', 
//    getUsername()
//  )
...
/*$("#button_ser_remove").prop('disabled', true);*/
            ...
            if (e !== null) {
                ...
                for (i = 0; i < values.length; i++) {
                    if (i <= 10) {
                        ...
                        htmls += `<span style="padding:1%;"><input type="checkbox"  class="checkbox_service" id="SERVICE_` + values[i].SER_ID + `" placeholder="" class="input" />  <span class="label_service" id="lbserSERVICE_` + values[i].SER_ID + `" > บริการ ` + values[i].SER_NAME + ` </span> </span>  `
...
//$("#Service_select").on('draw', function () {

//        fuc_edit_Service("#Service")
//        $("#button_Service_add_save").prop('disabled', true);
//        $("#button_ser_remove").prop('disabled', true);
//    })
        ...
        buttons: [
         ...
         columns: [
            ...
            { data: 'CUST_SNAME', title: 'นามสกุล' },
             { data: 'SERVICE_21', title: 'บริการ Service ดวงไพ่ยิปซี อ.เนตรทิพย์' },
             { data: 'SERVICE_11', title: 'บริการ VDO HORO รวมโหรดัง' },
             { data: 'SERVICE_12', title: 'Service เสริมทรัพทย์เสริมโชค' },
