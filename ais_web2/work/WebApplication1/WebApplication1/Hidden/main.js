...
function sum2(table) {
    if (table[0].SUM == null) {
        $("#Label8_today").text("0")
        $("#Label9_today").text("0")
        $("#Label10_today").text("0")
    } else {
        $("#Label8_today").text(table[0].SUM)
        $("#Label9_today").text(table[0].SER01)
        $("#Label10_today").text(table[0].SER02)
    }
