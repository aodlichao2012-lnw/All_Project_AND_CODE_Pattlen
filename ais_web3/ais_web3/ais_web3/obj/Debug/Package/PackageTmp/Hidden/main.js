...
function showreportToday() {
    ...
    $.ajax({
        url: '/All/showreportToday?connectionstring=' + sessionStorage.getItem("strcon") + "&Agen=" + sessionStorage.getItem("Agen"),
        cache: false,
        type: 'GET',
        data: null,
        success: function (e) {
...
function fuclogout() {
    ...
    let ajax_ = $.ajax({
        url: "/All/SingOut?&connectionstring=" + sessionStorage.getItem("strcon") + "&Agen=" + sessionStorage.getItem("Agen"),
        type: 'GET',
        success: function (e) {
            if (e === "server มี ปัญหา") {
                clearAllCookies();
                sessionStorage.setItem("strcon" ,"")
                sessionStorage.setItem("Agen" ,"")
                sessionStorage.setItem("Tel", "")
                sessionStorage.setItem("user_name", "")
                sessionStorage.setItem("strcon", "")
                sessionStorage.setItem("type_db", "")
...
function fuc_edit_Service(Service) {
    ...
    $.ajax({
        url: '/All/list_Service2?connectionstring=' + sessionStorage.getItem("strcon"),
        type: 'GET'
        , success: function (e) {
            if (e !== null) {
...
function fuc_select_status_2() {
    let ajax_ = $.ajax({
        url: "/All/showCity?connectionstring=" + sessionStorage.getItem("strcon")
        , type: "GET",
        success: function (e) {
            if (e === "") {
                Cache_item()
...
function button_ser_save(value, id) {
    let ajax_ = $.ajax({
        url: '/All/Save_service?id=' + id + "&values=" + value,
        type: 'GET',
        data: null,
        success: function (e) {
            alert2(e)
...
function cbostatus() {
    let ajax_ = $.ajax({
        url: '/All/FrmReportTel_Load?connectionstring=' + sessionStorage.getItem("strcon"),
        type: 'GET',
        data: null,
        success: function (e) {
            if (e === "server มี ปัญหา") {
...
function appendToFormData(datas , key, value) {
    if (!datas.has(key)) {
...
function fuc_select_status() {
    let ajax_ = $.ajax({
        url: "/All/setcboStatus?connectionstring=" + sessionStorage.getItem("strcon")
        , type: "GET",
...
function getfuc() {
    ...
    if (sessionStorage.getItem("ishastel") == "")
        $.ajax({
            url: '/All/FrmStatus_Load?Agen=' + sessionStorage.getItem("Agen") + "&connectionstring=" + sessionStorage.getItem("strcon") + "&Tel=" + sessionStorage.getItem("Tel"),
            type: "GET",
            data: null,
            cache: false,
            success: function (e) {
                ...
                if (status === "Busy") {
                    ...
                    if (sessionStorage.getItem("Tel" ) == "" || sessionStorage.getItem("Tel" ) == null) {
                        ...
                        $("#txt_tel").val(sessionStorage.getItem("Tel"))
...
//    window.location.href = '/FrmSearchNumber/Index?connectionstring=' + sessionStorage.getItem("strcon")

//})
$("#button_Main").on('click', function (e) {

    window.location.href = '/All/Detail?connectionstring=' + sessionStorage.getItem("strcon")

})
$("#button_Report").on('click', function (e) {

    window.location.href = '/All/FrmReport?usernane=' + sessionStorage.getItem("user_name")
...
$("#svg1").on('click', function (e) {
    ...
    window.location.href = '/All/Index?connectionstring=' + sessionStorage.getItem("strcon")
...
function fuc_select_change_reson() {
    ...
    let ajax_ = $.ajax({
        url: "/All/cboStatus_SelectedIndexChanged?cboStatus=" + reson_select + "&res_code=" + reson_select + "&connectionstring=" + sessionStorage.getItem("strcon")
        , type: "GET",
        success: function (e) {
