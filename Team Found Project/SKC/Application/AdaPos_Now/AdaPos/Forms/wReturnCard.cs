    ...
    public partial class wReturnCard : Form
    {
        ...
        private void otbReceived_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //if (atDot[1].Length >= 2)
                    if (atDot[1].Length >= cVB.nVB_DecShow && Convert.ToDecimal(otbReceived.Text) != 0)
                        e.Handled = true;
                }
        ...
        private void W_GENxDocumentCrdTouUp()
        {
            ...
            try
            {
                ...
                if (bStaPrc == true)
                {
                    ...
                    aoSqlParam = new SqlParameter[] {
                        new SqlParameter ("@ptSatStaResetBill", SqlDbType.VarChar, 1){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatStaResetBill"].ToString()},
                        new SqlParameter ("@ptSatRetFmtChar", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatRetFmtChar"].ToString()},
                        new SqlParameter ("@ptSatRetFmtYear", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatRetFmtYear"].ToString()},
                        new SqlParameter ("@ptSatRetFmtMonth", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatRetFmtMonth"].ToString()},
                        new SqlParameter ("@ptSatRetFmtDay", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatRetFmtDay"].ToString()},
                        new SqlParameter ("@ptSatRetFmtNum", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatRetFmtNum"].ToString()},
                        new SqlParameter ("@ptSatRetFmtAll", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatRetFmtAll"].ToString()},
                        new SqlParameter ("@ptBchCode", SqlDbType.VarChar, 5){
                            Value = oDbTblAutoFmt.Rows[0]["FTBchCode"].ToString()},
                        new SqlParameter ("@ptField", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTPKField"].ToString()},
                        new SqlParameter ("@ptTableName", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTTableName"].ToString()},
                        new SqlParameter ("@ptDocType", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTDocType"].ToString()},
                        new SqlParameter ("@ptSatDocTypeName", SqlDbType.VarChar, 50){
                            Value = oDbTblAutoFmt.Rows[0]["FTSatDocTypeName"].ToString()},
                        new SqlParameter ("@rtReturnResult", SqlDbType.VarChar, 100){
