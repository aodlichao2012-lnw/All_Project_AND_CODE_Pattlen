    ...
    public partial class wHome : Form
    {
        ...
        private void wHome_Shown(object sender, EventArgs e)
        {
            ...
            { 
                ...
                if (!string.IsNullOrEmpty(cVB.tVB_ShfCode))
                {
                    ...
                    if (cVB.tVB_ShfCreateOn != DateTime.Today.ToString("yyyy-MM-dd"))    //*Em 63-08-09
                    {
                        new cSP().SP_SHWxMsg(cVB.oVB_GBResource.GetString("tMsgShiftDateInvalid"), 1);
                    }
                }
                //++++++++++++++++++++
                //*Net 63-07-08 clear หน้าจอ 2 ตอนเช้าหน้า Home
                if (cVB.oVB_CstScreen != null)
                {
                    cVB.oVB_CstScreen.W_SETxClearDoc();
                    //cVB.oVB_CstScreen.W_SETxHeader(ptUsrName: cVB.tVB_UsrName);
                    cVB.oVB_CstScreen.W_SETxHeader(ptUsrName: cVB.tVB_ShwUsrName); //*Arm 63-08-11
                }
                //+++++++++++++++++++
            }
        ...
        private void W_SETxText()
        {
            try
            {
                ...
                //olaUsrName.Text = cVB.tVB_UsrName; //*Arm 63-08-11 Comment Code
