    ...
    public partial class wTaxInvoice : Form
    {
        ...
        private void ocmAccept_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (oTax.C_DOCbInsertTaxWithSQL(tW_TaxDocNo, otbTicketNo.Text.Trim(),true))
                    {
                        oSql.AppendLine("UPDATE TPSTTaxHD WITH(ROWLOCK)");
                        ...
                        oSql.AppendLine("BEGIN");
                        oSql.AppendLine("	INSERT INTO TCNMTaxAddress_L (FTAddTaxNo,FNLngID,FTAddVersion,FTAddV2Desc1,FTAddStaBusiness,FTAddStaHQ,FTAddStaBchCode"); //*Arm 63-05-26 เอา WITH(ROWLOCK) ออก
