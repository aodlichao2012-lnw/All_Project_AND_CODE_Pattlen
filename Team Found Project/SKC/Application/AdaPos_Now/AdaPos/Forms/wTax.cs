...
using AdaPos.Models.Webservice.Required.GenDocNo;
...
namespace AdaPos.Forms
{
    public partial class wTax : Form
    {
        ...
        private string tW_TblSalHD = "TSHD" + cVB.tVB_PosCode;
        private string tW_TblSalHDCst = "TSHDCst" + cVB.tVB_PosCode;
        private string tW_TblSalHDDis = "TSHDDis" + cVB.tVB_PosCode;
        private string tW_TblSalDT = "TSDT" + cVB.tVB_PosCode;
        private string tW_TblSalDTDis = "TSDTDis" + cVB.tVB_PosCode;
        private string tW_TblSalDTPmt = "TSDTPmt" + cVB.tVB_PosCode;
        private string tW_TblSalRC = "TSRC" + cVB.tVB_PosCode;
        private string tW_TblSalRD = "TSRD" + cVB.tVB_PosCode;
        private string tW_TblSalPD = "TSPD" + cVB.tVB_PosCode;
        ...
        private void W_SETxDesign()
        {
            try
            {
                ...
                opbLogo.Image = new cCompany().C_GEToImageLogo();   //*Em 63-07-28 //*Net 63-07-31 ปรับตาม Moshi
        ...
        private void W_SETxText()
        {
            try
            {
                ...
                //*Net 63-07-31 ปรับตาม Moshi
                otbTitleQty.DefaultCellStyle.Format = $"N{cVB.nVB_DecShow}"; //*Net 63-06-24 ปรับทศนิยมตาม Option
                otbTitleDisChg.DefaultCellStyle.Format = $"N{cVB.nVB_DecShow}"; //*Net 63-06-24 ปรับทศนิยมตาม Option
                otbTitleAmt.DefaultCellStyle.Format = $"N{cVB.nVB_DecShow}"; //*Net 63-06-24 ปรับทศนิยมตาม Option
                ...
                //*Net 63-07-31 ปรับตาม Moshi
                olaAmtAftDisChg.Text = oW_SP.SP_SETtDecShwSve(1, 0m, cVB.nVB_DecShow); //*Net 63-06-24 ปรับทศนิยม
                olaAmtDisChg.Text = oW_SP.SP_SETtDecShwSve(1, 0m, cVB.nVB_DecShow); //*Net 63-06-24 ปรับทศนิยม
                olaAmtNet.Text = oW_SP.SP_SETtDecShwSve(1, 0m, cVB.nVB_DecShow); //*Net 63-06-24 ปรับทศนิยม
                olaAmtTotal.Text = oW_SP.SP_SETtDecShwSve(1, 0m, cVB.nVB_DecShow); //*Net 63-06-24 ปรับทศนิยม
                olaAmtTotalVat.Text = oW_SP.SP_SETtDecShwSve(1, 0m, cVB.nVB_DecShow); //*Net 63-06-24 ปรับทศนิยม
            }
        ...
        private void W_GETxData()
        {
            ...
            {
                //*Net 63-05-26
                tW_TblSalHD = "TSHD" + cVB.tVB_PosCode;
                tW_TblSalHDCst = "TSHDCst" + cVB.tVB_PosCode;
                tW_TblSalHDDis = "TSHDDis" + cVB.tVB_PosCode;
                tW_TblSalDT = "TSDT" + cVB.tVB_PosCode;
                tW_TblSalDTDis = "TSDTDis" + cVB.tVB_PosCode;
                tW_TblSalDTPmt = "TSDTPmt" + cVB.tVB_PosCode;
                ...
                oSql.AppendLine($"FROM {tW_TblSalHD} WITH(NOLOCK)");
                oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "'");
                oSql.AppendLine("AND FTXshStaDoc = '1' AND ISNULL(FTXshDocVatFull,'') = '' ");  //*Em 63-05-25
                oW_TaxHD = new cmlTPSTTaxHD();
                oW_TaxHD = oDB.C_GEToDataQuery<cmlTPSTTaxHD>(oSql.ToString());

                //*Net 63-05-25 ถ้าหาจากตาราง Tmp ไม่เจอให้หาในตารางจริง
                if (oW_TaxHD == null)
                {

                    tW_TblSalHD = "TPSTSalHD";
                    tW_TblSalHDCst = "TPSTSalHDCst";
                    tW_TblSalHDDis = "TPSTSalHDDis";
                    tW_TblSalDT = "TPSTSalDT";
                    tW_TblSalDTDis = "TPSTSalDTDis";
                    tW_TblSalDTPmt = "TPSTSalDTPmt";
                    tW_TblSalRC = "TPSTSalRC";
                    tW_TblSalRD = "TPSTSalRD";
                ...
                if (oW_TaxHD != null)
                {
                    ...
                    oSql.AppendLine($"FROM {tW_TblSalHDCst} WITH(NOLOCK)"); //*Net 63-05-25
                    oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "'");
                    ...
                    oSql.AppendLine($"FROM {tW_TblSalHDDis} WITH(NOLOCK)"); //*Net 63-05-25
                    oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "'");
                    ...
                    oSql.AppendLine("(DT.FCXsdQty * ISNULL(PD.FCXsdSetPrice,DT.FCXsdSetPrice)) AS FCXsdAmtB4DisChg, FTXsdDisChgTxt,ISNULL(DT.FCXsdDis,0) AS FCXsdDis, ISNULL(DT.FCXsdChg,0) AS FCXsdChg, ");
                    ...
                    oSql.AppendLine("ISNULL(DT.FCXsdNet,0) AS FCXsdNet, FCXsdNetAfHD, FCXsdVat, FCXsdVatable, FCXsdWhtAmt, FTXsdWhtCode, FCXsdWhtRate, ");
                    ...
                    oSql.AppendLine($"FROM {tW_TblSalDT} DT WITH(NOLOCK)"); //*Net 63-05-25
                    ...
                    oSql.AppendLine($"   FROM {tW_TblSalPD} PD WITH(NOLOCK)"); //*Net 63-05-25
                    ...
                    oSql.AppendLine($"   	FROM {tW_TblSalPD} WITH(NOLOCK)"); //*Net 63-05-25
                    ...
                    oSql.AppendLine($"			FROM {tW_TblSalDTDis} WITH(NOLOCK)"); //*Net 63-05-25
                    oSql.AppendLine("			WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "'");
                    ...
                    oSql.AppendLine($"           AND FTXddRefCode NOT IN (SELECT DISTINCT FTPmhDocNo FROM {tW_TblSalPD} WITH(NOLOCK) WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "' AND FTXpdGetType = '4')))"); //*Net 63-05-25
                    ...
                    oSql.AppendLine($"FROM {tW_TblSalDTPmt} WITH(NOLOCK)"); //*Net 63-05-25
                    oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "'");
                    ...
                    oSql.AppendLine($"FROM {tW_TblSalRC} WITH(NOLOCK)"); //*Net 63-05-25
                    oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "'");
        ...
        public void W_PRNxDrawTax(Graphics poGraphic)
        {
            ...
            try
            {
                ...
                {
                    nStartY += 18;
                    tMsg = "!!! " + oW_Resource.GetString("tCopy") + " " + (oW_TaxHD.FNXshDocPrint+1) + " !!!"; //*Arm 62-11-12 จำนวนครั้งที่พิมพ์สำเนา
                    oGraphic.DrawString(tMsg, oFont, Brushes.Black, new RectangleF(0, nStartY, nWidth, 18), oFormatCenter);
                }
                //ท้ายใบเสร็จ
                nStartY += 18;
        ...
        private void W_KBDxTaxApvDoc()
        {
            ...
            try
            {
                ...
                //*Arm 63-05-15 - Gen. Document No.
                cmlReqGenDocNo oReq = new cmlReqGenDocNo();
                oReq.ptBchCode = cVB.tVB_BchCode;
                oReq.pnSaleType = oW_TaxHD.FNXshDocType.Value;

                string tJSonCall = JsonConvert.SerializeObject(oReq);
                string tUrl = cVB.tVB_API2PSSale;
                ...
                try
                {
                    oRep = oCall.C_POSToInvoke(tUrl + "/GenDocNo/TaxDocNo", tJSonCall);
                }
                catch (Exception oEx)
                {
                    new cLog().C_WRTxLog("wTax", "W_KBDxTaxApvDoc : " + oEx.Message);
                    tW_TaxDocNo = "";
                    return;
                }
                ...
                if (oRep.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    cmlResItem<string> oRes = JsonConvert.DeserializeObject<cmlResItem<string>>(tJSonRes);
                    if (oRes.rtCode == "001")
                    {
                        tW_TaxDocNo = oRes.roItem;
                    }
                    else
                    {
                        tW_TaxDocNo = "";
                        new cLog().C_WRTxLog("wTax", "W_KBDxTaxApvDoc/API Response Code " + oRes.rtCode + ":" + oRes.rtDesc);
                    }
                }
                ...
                //tW_TaxDocNo = oTax.C_GENtDocNo(oW_TaxHD.FNXshDocType.Value); //*Arm 63-05-15 Comment Code
                if (!string.IsNullOrEmpty(tW_TaxDocNo))
                {
                    otbTaxNo.Text = tW_TaxDocNo;
                    if (oTax.C_DOCbInsertTaxWithSQL(tW_TaxDocNo, otbSlipNo.Text.Trim(), tW_TblSalHD.StartsWith("TSHD")))
                    {
                        oSql.AppendLine("UPDATE TPSTTaxHD WITH(ROWLOCK)");
                        ...
                        oSql.AppendLine($"UPDATE {tW_TblSalHD} WITH(ROWLOCK)"); //*Net 63-05-26 ถ้าเลือกเอกสารจากที่ไหนไปอัพเดตที่นั่น
                        ...
                        oSql.AppendLine("BEGIN");
                        oSql.AppendLine("	INSERT INTO TCNMTaxAddress_L (FTAddTaxNo,FNLngID,FTAddVersion,FTAddV2Desc1,FTAddV2Desc2,FTAddStaBusiness,FTAddStaHQ,FTAddStaBchCode"); //*Arm 63-05-26 เอา WITH(ROWLOCK) ออก
                        ...
                        new cSyncData().C_PRCxSyncUld(true);    //*Em 63-05-27
                        new cSP().SP_SHWxMsg(oW_Resource.GetString("tMsgPrcComplete"), 1);
                        bW_StaApv = true; //*Net 63-07-31 ปรับตาม Moshi
                        W_GETxDataTax();
                        W_PRCxLock(true);
                    }
                }
        ...
        private void ocmSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                oSql.AppendLine("SET FNXshAddrTax = (");
                oSql.AppendLine("   SELECT FNAddSeqNo FROM TCNMTaxAddress_L WHERE FTAddTaxNo = '" + otbIDCard.Text.Trim() + "' AND FNLngID = " + cVB.nVB_Language + ")");
                oSql.AppendLine(",FTXshCardID = '" + otbIDCard.Text + "'");
                oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + tW_TaxDocNo + "'");
                oDB.C_SETxDataQuery(oSql.ToString());
                //++++++++++++++++
        ...
        //*Net 63-05-25
        private void otbSlipNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                try
                {
                    if (!string.IsNullOrEmpty(otbSlipNo.Text))
                    {
                        ...
                        if (string.IsNullOrEmpty(oW_TaxHD.FTXshDocVatFull))
                        {
                            W_SETxData(1);
                        }
                        else
                        {
                            tW_TaxDocNo = oW_TaxHD.FTXshDocVatFull;
                            otbTaxNo.Text = tW_TaxDocNo;
                            W_GETxDataTax();
                            W_SETxData(2);
                        }
                ...
                catch (Exception oEx) { new cLog().C_WRTxLog("wTaxInvoice", "otbSlipNo_KeyDown : " + oEx.Message); }
