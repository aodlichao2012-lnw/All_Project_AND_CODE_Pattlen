...
namespace AdaPos.Models.Webservice.Respond.KADS.Customer
{
    public class cmlResCstKADRef
    {
        ...
        public cmlPrivilegeRef PrivilegePointSet { get; set; }
    ...
    public class cmlPrivilegeRef
    {
        public IList<cmlResPriviRef> results { get; set; }
    }

    public class cmlResPriviRef
    {
        //public Metadata __metadata { get; set; }
        public string KubotaId { get; set; }
