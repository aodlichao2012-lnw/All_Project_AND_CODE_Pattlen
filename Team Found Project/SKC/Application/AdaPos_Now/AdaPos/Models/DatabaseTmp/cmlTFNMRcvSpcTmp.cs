...
namespace AdaPos.Models.DatabaseTmp
{
    public class cmlTFNMRcvSpcTmp
    {
        ...
        ///// <summary>
        //public string FTAppStaAlwRet { get; set; }        //*Arm 63-07-30 Comment Code (ยกเลิก)

        ///// <summary>
        /////1: อนุญาต ให้ ทำการยกเลิกรายการได้ 2 :ไม่อนุญาต ให้ ทำการยกเลิกรายการ
        ///// <summary>
        //public string FTAppStaAlwCancel { get; set; }     //*Arm 63-07-30 Comment Code (ยกเลิก)

        ///// <summary>
        /////1: อนุญาต ให้ มีรายการอื่น ต่อท้าย 2 :ไม่อนุญาต ให้ มีรายการอื่น ต่อท้าย
        ///// <summary>
        //public string FTAppStaPayLast { get; set; }       //*Arm 63-07-30 Comment Code (ยกเลิก)
    }
}
