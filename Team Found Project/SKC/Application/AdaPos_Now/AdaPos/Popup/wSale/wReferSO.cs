    ...
    public partial class wReferSO : Form
    {
        ...
        public wReferSO(string ptCstCode)
        {
            ...
            try
            {
                ...
                W_SETxDesign();
                W_SETxText();
                new cLog().C_WRTxLog("wReferSO", "Call API2ARDoc ==> OrdersByList Start...", cVB.bVB_AlwPrnLog); //*Arm 63-05-11
                W_GETxOrdersByList(ptCstCode);  // Get SO
                new cLog().C_WRTxLog("wReferSO", "Call API2ARDoc ==> OrdersByList End...", cVB.bVB_AlwPrnLog); //*Arm 63-05-11
        ...
        private void ocmAccept_Click(object sender, EventArgs e)
        {
            try
            {
                new cLog().C_WRTxLog("wReferSO", "Call API2ARDoc ==> W_GETxOrdersByDoc  Start...", cVB.bVB_AlwPrnLog); //*Arm 63-05-11
                tW_DocNo = ogdSo.CurrentRow.Cells["otbDocNo"].Value.ToString();
                W_GETxOrdersByDoc(tW_DocNo);
                this.DialogResult = DialogResult.OK;
                this.Close();
                new cLog().C_WRTxLog("wReferSO", "Call API2ARDoc ==> W_GETxOrdersByDoc  End...", cVB.bVB_AlwPrnLog); //*Arm 63-05-11
            }
            catch(Exception oEx)
            {
