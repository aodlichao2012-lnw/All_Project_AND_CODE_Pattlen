    ...
    public partial class wEDC : Form
    {
        ...
        private void W_PRCxPayment()
        {
            try
            {
                ...
                //oW_EDC.SetNetAmt =Convert.ToDouble( cVB.cVB_Amount); //*Arm 63-09-01 Comment Code
                oW_EDC.SetNetAmt = Convert.ToDouble(new cSP().SP_SETtDecShwSve(2, cVB.cVB_Amount, 2)); //*Arm 63-09-01 �Ѵ��ɷȹ��� 2 ���˹�
        ...
        protected override void OnPaintBackground(PaintEventArgs e)
        {
            ...
            catch (Exception oEx) { new cLog().C_WRTxLog("wEDC", "OnPaintBackground " + oEx.Message); }
        }
        /// <summary>
        /// Set design
        /// </summary>
        ...
        private void W_CHKxBankCode(DataTable poData)
        {
            ...
            else
            {
                ...
                //*Em 63-06-23
                if (bW_StatusEDC == true)
                {
                    tCodeBank = "OTHER";
                    tCrdCode = "OTHER";
                    otbSelectBank.Text = "Others";
                    otbCardName.Text = "Others";
                    return;
                }
                //+++++++++++++++++
