...
namespace AdaPos.Popup.wPayment
{
    public partial class wCouponRedeem : Form
    {
        ...
        protected override void OnPaintBackground(PaintEventArgs e)
        {
            ...
            catch (Exception oEx) { new cLog().C_WRTxLog("wCouponRedeem", "OnPaintBackground " + oEx.Message); }
        }
        ...
        private void ocmAccept_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception oEx) { new cLog().C_WRTxLog("wCouponRedeem", "ocmAccept_Click : " + oEx.Message); }
        }
        ...
        private void W_SETxDesign()
        {
            try
            {
                ...
                //opnHeader.BackColor = cVB.oVB_ColNormal; //*Arm 63-08-11 Comment Code
        ...
        private void W_SHWxCouponDetail(cmlCouponDisDetail poCpnDT)
        {
            ...
            {
                new cLog().C_WRTxLog("wCouponRedeem", "W_SHWxCouponDetail : " + oEx.Message);
            }
        }
        ...
        private cmlCouponDisDetail W_CHKxAPICoupon(cmlTPSTCouponHD_Tmp poCpn)
        {
            ...
            try
            {
                new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Start", cVB.bVB_AlwPrnLog); //*Net Stamp
                string tUrl = "";
                if (nW_StaChkHQ == 1)
                {
                    tUrl = cVB.tVB_API2FNWalletHQ;
                    new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Get API HQ", cVB.bVB_AlwPrnLog); //*Net Stamp
                }
                else
                {
                    tUrl = cVB.tVB_API2FNWallet; 
                    new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : GET API Bch", cVB.bVB_AlwPrnLog); //*Net Stamp
                }
                ...
                else
                {
                    ...
                    try
                    {
                        new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Call API2Wallet CheckCouponHD", cVB.bVB_AlwPrnLog); //*Net Stamp
                        oRep = oCall.C_POSToInvoke(tUrl + "/Coupon/CheckCouponHD", tJSonCall);
                    }
                    catch (Exception oEx)
                    {
                        new cLog().C_WRTxLog("wCouponRedeem", "W_CHKxAPICoupon : " + oEx.Message);
                        return null;
                    }
                    new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Get Response API Status {oRep.StatusCode}", cVB.bVB_AlwPrnLog); //*Net Stamp
                    if (oRep.StatusCode == System.Net.HttpStatusCode.OK)
                    {
                        ...
                        else
                        {
                            oCall.C_PRCxCloseConn();    //*Em 63-07-18
                            //oW_SP.SP_SHWxMsg(oW_Resource.GetString("tMsgNoItemOrUsed"), 1);
                            new cLog().C_WRTxLog("wCouponRedeem", "W_CHKxAPICoupon : " + oRes.rtDesc);
                            return null;
                        }
                    }
                    else
                    {
                        oCall.C_PRCxCloseConn();    //*Em 63-07-18
                        new cLog().C_WRTxLog("wCouponRedeem", "W_CHKxAPICoupon : " + tUrl + " " + oRep.StatusCode);
                        return null;
                    }
                }
            }
            catch (Exception oEx) { new cLog().C_WRTxLog("wCouponRedeem", "W_CHKxAPICoupon : " + oEx.Message); }
            finally
            {
        ...
        private bool W_PRCbCoupon()
        {
            ...
            try
            {
                ...
                //{
                //    new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : API Centralized"); //*Net Stamp
                //    nW_StaChkHQ = 1;
                //}
                if (nW_StaChkHQ == 1)
                {
                    new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Get MQ HQ", cVB.bVB_AlwPrnLog); //*Net Stamp
                    //if (cVB.tVB_API2FNWalletHQ == cVB.tVB_API2FNWallet)
                    //{
                ...
                {
                    new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Get MQ Bch", cVB.bVB_AlwPrnLog); //*Net Stamp
                ...
                new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Connect MQ", cVB.bVB_AlwPrnLog); //*Net Stamp
                ...
                new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : Start Publish", cVB.bVB_AlwPrnLog); //*Net Stamp
                ...
                new cLog().C_WRTxLog("wCouponRedeem", MethodBase.GetCurrentMethod().Name + $" : End", cVB.bVB_AlwPrnLog); //*Net Stamp
                return true;
            }
            catch (Exception oEx) 
            { 
                new cLog().C_WRTxLog("wCouponRedeem", "W_PRCxCoupon : " + oEx.Message); return false; 
            }
        }
        private void oVB_Coupon_Receive(object sender, EventArgs e)
        {
            ...
            catch (Exception oEx) { new cLog().C_WRTxLog("wCouponRedeem", "oVB_Coupon_Receive : " + oEx.Message); }
        }
