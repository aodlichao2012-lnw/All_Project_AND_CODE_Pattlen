...
namespace AdaTask.Event
{
    class cEvent3
    {
        ...
        {
            new cLog().C_WRTxLog("cEvent3", "C_PROxRequestTranferSAPByJSON : RabbitPublish");
            cSP oC_CSP = new cSP();
            ...
            try
            {
                ...
                new cLog().C_WRTxLog("cEvent3", "C_PROxRequestTranferSAPByJSON : ExportFIN");
                Console.WriteLine("cEvent3 > C_PROxRequestTranferSAPByJSON : ExportFIN");
                ...
                new cLog().C_WRTxLog("cEvent3", "C_PROxRequestTranferSAPByJSON : Success.");
                Console.WriteLine("cEvent3 > C_PROxRequestTranferSAPByJSON : Success.");

            }
            catch (Exception oEx)
            {
                Console.WriteLine("cEvent3 > C_PROxRequestTranferSAPByJSON() : " + oEx.Message);
            }
            finally
            {
