...
using MQReceivePrc.Models.Other;
using System;
...
namespace AdaPos.Class
{
    ...
    {
        private string tC_ConnStr = "";
        private int nC_CmdTime;
        public cMsgRemind()
        {
            try
            {
                tC_ConnStr = new cDatabase().C_GETtConnectString(cVB.oVB_ShopDB.tServer, cVB.oVB_ShopDB.tUser, cVB.oVB_ShopDB.tPassword, cVB.oVB_ShopDB.tDatabase, (int)cVB.oVB_ShopDB.nConnectTimeOut, cVB.oVB_ShopDB.tAuthenMode);
                nC_CmdTime = (int)cVB.oVB_ShopDB.nCommandTimeOut;
            }
            catch (Exception oEx)
            {
                new cLog().C_WRTxLog("cMsgRemind", "cMsgRemind : " + oEx.Message);
            }
        }
        ...
        public List<cmlTCNTMsgRemind> C_GETaMsgRemind()
        {
            ...
            try
            {
                ...
                nNotRead = new cDatabase().C_DAToExecuteQuery<int>(tC_ConnStr,oSql.ToString(),nC_CmdTime);
                if (nNotRead > 0)
                {
                    oSql.Clear();
                ...
                aoMsgRemind = new cDatabase().C_GETaDataQuery<cmlTCNTMsgRemind>(tC_ConnStr,oSql.ToString(),nC_CmdTime);
            }
        ...
        public void C_INSxMsgRemind(cmlTCNTMsgRemind poMsg, cmlMsgLng poMsgL)
        {
            ...
            try
            {
                ...
                new cDatabase().C_DATbExecuteNonQuery(tC_ConnStr,oSql.ToString(),nC_CmdTime,out nRowEff);
            }
        ...
        public int C_GETnMaxSeq()
        {
            ...
            try
            {
                ...
                nSeq = new cDatabase().C_DAToExecuteQuery<int>(tC_ConnStr,oSql.ToString(),nC_CmdTime);
            }
