...
namespace AdaPos.Models.Webservice.Respond.ProductPromotion
{
    public class cmlResInfoPdtPmtCG
    {
        ...
        /////ลำดับ
        ///// </summary>
        //public Nullable<Int64> rnFNPgtSeq { get; set; }
        ...
        /////1:ตามคำนวน 2:ตามช่วง 3:ตามกลุ่ม 4:ทุกกลุ่ม
        ///// </summary>
        //public string rtFTPgtStaGetEffect { get; set; }

        ///// <summary>
        /////1:ลดบาท 2:ลด% 3:ปรับราคา 4:.ใช้กลุ่มราคา 5:แถม(Free) 6:ไม่กำหนด
        ///// </summary>
        //public string rtFTPgtStaGetType { get; set; }

        ///// <summary>
        /////เงื่อนไขการเลือกสินค้ากรณี>1รายการในบิล 1:ราคามากกว่า 2:ราคาน้อยกว่า 3:user เลือก
        ///// </summary>
        //public string rtFTPgtStaGetPdt { get; set; }
        ...
        /////มูลค่า แปรผันตามรูปแบบส่วนลด
        ///// </summary>
        //public Nullable<double> rcFCPgtGetvalue { get; set; }
        ...
        /////จำนวนที่จะได้รับ
        ///// </summary>
        //public Nullable<double> rcFCPgtGetQty { get; set; }

        ///// <summary>
        /////%เฉลี่ย รวมกันต้องเท่ากับ 100
        ///// </summary>
        //public Nullable<double> rcFCPgtPerAvgDis { get; set; }

        ///// <summary>
        /////การให้แต้ม 1:ไม่กำหนด 2:.ให้แต้ม
        ///// </summary>
        //public string rtFTPgtStaPoint { get; set; }

        ///// <summary>
        /////การคำนวณตาม 1:มูลค่า 2:จำนวน
        ///// </summary>
        //public string rtFTPgtStaPntCalType { get; set; }

        ///// <summary>
        /////ประเภทสินค้าร่วมรายการ 1:Product 2:Brand
        ///// </summary>
        //public string rtFTPgtStaPdtDT { get; set; }

        ///// <summary>
        /////อัตราส่วนแต้มที่จะได้รับ  (ต้นทางจากBuy)
        ///// </summary>
        //public Nullable<Int64> rnFNPgtPntGet { get; set; }

        ///// <summary>
        /////อัตราส่วนแต้มที่จะได้รับ
        ///// </summary>
        //public Nullable<Int64> rnFNPgtPntBuy { get; set; }

        ///// <summary>
        /////การให้สิทธิ์ 1:ไม่กำหนด 2:.ให้สิทธิ์คูปอง 3:ข้อความ
        ///// </summary>
        //public string rtFTPgtStaCoupon { get; set; }

        ///// <summary>
        /////ข้อความ ท้ายบิล
        ///// </summary>
        //public string rtFTPgtCpnText { get; set; }

        ///// <summary>
        /////รหัสเอกสารคูปอง (Bar in DT)
        ///// </summary>
        //public string rtFTCphDocNo { get; set; }
    }
}
