    ...
    public partial class wPayment : Form
    {
        ...
        private void W_SETxText()
        {
            try
            {
                ...
                ogdSum.Rows.Add(oW_Resource.GetString("tNetSale"), oW_SP.SP_SETtDecShwSve(1, cW_AmtTotalCal, 2));
                                ...
                                if (oResponse.StatusCode == System.Net.HttpStatusCode.OK)
                                {
                                    ...
                                    switch (oResTopup.rtCode)
                                    {
                                        ...
                                        default:
                                            ...
                                            otbAmount.Focus();
                                            new cLog().C_WRTxLog("wTopUp", "W_PRCxAccept : " + oResTopup.rtCode + " (" + oResTopup.rtDesc + ")");
                                            return false;
                                            // break;
                                    }
                                }
        ...
        public void W_SETxPmtPdt()
        {
            ...
            try
            {
                ...
                oSql.AppendLine("WHERE FTBchCode = '" + cVB.tVB_BchCode + "' AND FTXshDocNo = '" + cVB.tVB_DocNo + "' AND FCXpdDisAvg <> 0");
                oSql.AppendLine("AND FTXpdGetType <> '4' ");        //*Em 63-05-05
