...
namespace AdaPos
{
    public partial class wSignin : Form
    {
        ...
        /// Check Login.
        /// </summary>
        private void W_CHKxLogin(cmlTCNMUser opUser, string ptInput_Pwd)
        {
                    ...
                    if (string.Equals(tPwdEnc, oUser.FTUsrPwd))
                    {
                        switch (nW_Mode)
                        {
                            ...
                            case 1: // Role
                                ...
                                //tChkRole = new cUser().C_CHKtUserRole(oUser.FTRolCode, tW_ScreenRole, tFuncCode);
        ...
        /// </summary>
        private void W_PRCxChooseLastUserForPwdAndPin(string ptProcess)
        {
            try
            {
                //*Em 62-06-18
