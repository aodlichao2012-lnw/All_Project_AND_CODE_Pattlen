...
namespace API2ARDoc.Controllers
{
    ...
    /// </summary>
    [RoutePrefix(cCS.tCS_APIVer + "/SaleDocRefer")]
    public class cSaleDocReferController : ApiController
    {
        /// <summary>
        ...
        public cmlResItem<cmlResSaleDwn> POST_DWNoDownloadSale(cmlReqSaleDwn poPara)
        {
            ...
            try
            {
                ...
                //{
                //    oResult.tCode = oMsg.tMS_RespCode;
                //    oResult.tDesc = oMsg.tMS_RespDesc;
                //    return oResult;
                //}
